            ...
            {symbols.length === 0 ? (
              ...
              <div key={symbol.id} className="flex items-center gap-2 p-2 rounded-lg border bg-background hover:bg-muted/50 transition-colors">
                <div className="flex-1 overflow-hidden">
                  <p className="font-semibold truncate">{symbol.symbolStandardIdentity} {symbol.symbolCategory}</p>
                  <p className="text-sm text-muted-foreground truncate">{symbol.symbolEchelon || 'No Echelon'}</p>
                </div>
