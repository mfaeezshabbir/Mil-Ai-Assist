...
export class SIDCValidator {
  ...
  static parse(sidc: string) {
    if (sidc.length !== 20) {
      throw new Error(
        `Invalid SIDC length: ${sidc.length}. Expected 20 characters.`
      );
    }
...
export function getModifier1Options(symbolSet: string) {
  return (
    getSymbolSetData(symbolSet).modifier1 || [
      { name: "Unspecified", code: "00" },
    ]
  );
}
...
export function getModifier2Options(symbolSet: string) {
  return (
    getSymbolSetData(symbolSet).modifier2 || [
      { name: "Unspecified", code: "00" },
    ]
  );
}
...
export function getMainIconOptions(symbolSet: string) {
  return (
    getSymbolSetData(symbolSet).mainIcons || [
      { name: "Unspecified", code: "000000" },
    ]
  );
}
